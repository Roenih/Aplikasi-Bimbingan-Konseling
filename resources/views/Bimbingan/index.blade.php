    ...
    <body>
        <div class="container">
            <div class="card mt-2">
                ...
                <div class="card-body">
                    <a href="/tambah-bimbingan" class="btn btn-primary float-right"><i class=" fa fa-plus"></i>Tambah Bimbingan</a>
                    <br/>
                    <br/>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/delete-bimbingan/{{ $p->id_bimbingan }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                        </tbody>
