                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/update-siswa/{{ $siswa->nis }}">
                        ...
                        <div class="form-group">
                            <label for="kode_kelas">Kelas</label>
                                <select class="form-control" id="kode_kelas" name="kode_kelas">
                                    <option selected value="{{$siswa->kode_kelas}}">{{$siswa->kelas->nm_kelas}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" autocomplete="off" name="no_tlp" value="{{$siswa->no_tlp}}" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" autocomplete="off" name="email" value="{{$siswa->email}}" class="form-control">
